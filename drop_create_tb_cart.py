...
def drop_create_tb_cart():
    ...
    try:
        ...
        log.logger.info('objects credito.tmp_dbm_credito_pf - idx_tmpdbcredpf_01 created')#print('tabela tmp_dbm_credito_pf criada')
        ...
        log.logger.info('objects credito.tmp_dbm_credito_pj - idx_tmpdbcredpj_01 created')#print('tabela tmp_dbm_credito_pf criada')
        #os.system("pause")
