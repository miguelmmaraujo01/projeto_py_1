...
def p2p_create_tb_carteira_aging(identificador_arquivo):
    ...
    try:
        ...
        query_insert = "INSERT /*array */ INTO credito.p2p_cart_cobr_sum (cart_cobr, totalmr, porc) values (:1, :2, :3)"
        ...
        query_insert = "INSERT /*array */ INTO credito.p2p_cart_cobr_aging_valor (aging, recompra, biva_p2p, pagseguro_p2p ,totalmr) values (:1, :2, :3, :4, :5)"
        ...
        query_insert = "INSERT /*array */ INTO credito.p2p_cart_cobr_aging_qtd (aging, recompra, biva_p2p, pagseguro_p2p ,totalmr) values (:1, :2, :3, :4, :5)"
        ...
        query_insert = "INSERT /*array */ INTO credito.p2p_cart_cobr_aging_porc (aging, recompra, biva_p2p, pagseguro_p2p ,totalmr) values (:1, :2, :3, :4, :5)"
